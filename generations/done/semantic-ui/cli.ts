...
const CONFIG = {
    paths: {
    classMap: path.resolve(`./generations/semantic-ui/${FILE_NAMES.classMap}.json`),
    resultDir: path.resolve(`./generations/semantic-ui/${FILE_NAMES.outputDir}`),
    cssOutput: path.resolve(`./generations/semantic-ui/${FILE_NAMES.cssOutput}.css`),
  },
    ...
    // },
    {
      path: `./generations/semantic-ui/${FILE_NAMES.sourceDir}/HeroSplit.tsx`,
      name: 'HeroSplit',
    },
  ],
